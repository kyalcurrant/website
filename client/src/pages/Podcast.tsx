        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-10">
            ...
            <div>
              ...
              <p className="text-[#f5f0e8]/70 text-base leading-relaxed max-w-xl mb-6">Stories of transformation, resilience, and finding your voice. Each episode features someone who has overcome their fears and stepped into their power to share their message with the world.</p>
